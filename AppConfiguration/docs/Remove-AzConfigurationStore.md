...
online version: https://docs.microsoft.com/en-us/powershell/module/appconfiguration/remove-azconfigurationstore
schema: 2.0.0
---
...
```
Remove-AzConfigurationStore [-AsJob] -ConfigStoreName <String> [-DefaultProfile <PSObject>] [-PassThru]
